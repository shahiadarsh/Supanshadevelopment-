    ...
    <footer className="bg-gray-900 text-white pt-16 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/policies/workplace" className="hover:text-white transition-colors">Workplace Policy</Link></li>
              <li><Link href="/policies/sustainable" className="hover:text-white transition-colors">Sustainable Practices</Link></li>
              <li><Link href="/policies/privacy" className="hover:text-white transition-colors">Privacy Policy</Link></li>
              <li><Link href="/policies/donation" className="hover:text-white transition-colors">Donation and Refund Policy</Link></li>
              <li><Link href="/policies/crowdfunding" className="hover:text-white transition-colors">Crowdfunding Guidelines</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <span>123 Development Way, Sector 15, New Delhi - 110001</span>
              </li>
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex">
                <input 
                  ...
                  className="px-4 py-2 w-full text-gray-900 focus:ring-primary focus:border-primary rounded-l-md"
                  value={email}
        ...
        <div className="border-t border-gray-800 pt-6 text-center text-gray-500 text-sm">
          <p>2023–2025 © Supansha Development Foundation. All rights reserved. Crafted with Purpose.</p>
        </div>
      </div>
    </footer>
  );
